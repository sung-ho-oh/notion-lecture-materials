...
<div align="center">
  <br>
  <h3>👤 강사 소개</h3>
  <p><a href="https://gamma.app/docs/GenAI-PhD--jufle55uagr7hdm" target="_blank"><b>오성호 PhD</b></a></p>
  <br>
  <h3>📚 신간 소개</h3>
...
- [노트북LM 완전정복](#노트북LM-완전정복)
- [소스추가](#소스추가)
- [웹 또는 리서치 자료에서 실패한 소스 삭제하기](#웹-또는-리서치-자료에서-실패한-소스-삭제하기)
- [소스 품질 검사](#소스-품질-검사)
- [소스 목록 분류](#소스-목록-분류)
- ['Key Reference(핵심 참고문헌)'를 선정](#Key-Reference핵심-참고문헌를-선정)
- [핵심 참고 문헌의 정열 순서 변경](#핵심-참고-문헌의-정열-순서-변경)
- [특정 참고 문헌과 연관된 보고서 매칭](#특정-참고-문헌과-연관된-보고서-매칭)
- [대화를 나눈 결과를 다시 소스로 추가하기](#대화를-나눈-결과를-다시-소스로-추가하기)
- [소스: 텍스트](#소스-텍스트)
- [비주얼 및 글자깨짐 방지(최소화) 프롬프트](#비주얼-및-글자깨짐-방지최소화-프롬프트)
- [채팅 맞춤 설정](#채팅-맞춤-설정)
- [노트북LM의 크롬의 확장을 통한 이미지 프롬프트 추가 활용](#노트북LM의-크롬의-확장을-통한-이미지-프롬프트-추가-활용)
- [구글AI스튜디오에서 슬라이드 내용을 오브젝트로 분리하기](#구글AI스튜디오에서-슬라이드-내용을-오브젝트로-분리하기)
- [캡처 도구와 그림판 활용하기](#캡처-도구와-그림판-활용하기)
- [Gemini Gem x Notebook LM](#Gemini-Gem-x-Notebook-LM)
- [Opal 앱 만들기](#Opal-앱-만들기)
...
# <a id="노트북LM-완전정복"></a>노트북LM 완전정복: https://gamma.app/docs/LM-AI--ypmxsnoodt4n4bf
...
- **<a id="웹-또는-리서치-자료에서-실패한-소스-삭제하기"></a>웹 또는 리서치 자료에서 실패한 소스 삭제하기**
...
- **<a id="Key-Reference핵심-참고문헌를-선정"></a>'Key Reference(핵심 참고문헌)'를 선정**
...
- **<a id="핵심-참고-문헌의-정열-순서-변경"></a>핵심 참고 문헌의 정열 순서 변경**
...
- **<a id="특정-참고-문헌과-연관된-보고서-매칭"></a>특정 참고 문헌과 연관된 보고서 매칭**
...
- **<a id="대화를-나눈-결과를-다시-소스로-추가하기"></a>대화를 나눈 결과를 다시 소스로 추가하기**
    1. **유명 식당/관광지/숙소 찾기**
...
- **<a id="비주얼-및-글자깨짐-방지최소화-프롬프트"></a>비주얼 및 글자깨짐 방지(최소화) 프롬프트**
...
- **<a id="노트북LM의-크롬의-확장을-통한-이미지-프롬프트-추가-활용"></a>노트북LM의 크롬의 확장을 통한 이미지 프롬프트 추가 활용**
...
- **<a id="구글AI스튜디오에서-슬라이드-내용을-오브젝트로-분리하기"></a>구글AI스튜디오에서 슬라이드 내용을 오브젝트로 분리하기**
...
- **<a id="캡처-도구와-그림판-활용하기"></a>캡처 도구와 그림판 활용하기**

[목차 돌아가기](#목차-table-of-contents)

- **<a id="Gemini-Gem-x-Notebook-LM"></a>Gemini Gem x Notebook LM**
...
# <a id="Opal-앱-만들기"></a>Opal 앱 만들기: https://opal.google/landing/
